  ...
  private void configureBinds() {
    ...
    private void configureControllerBinds() { 
      ...
      //Swerve.get().setDefaultCommand(new TeleopSwerve(Controls.controller.getHID(), 1, 0, 4, Constants.deadBand,true, true));
        Swerve.get().setDefaultCommand(new TeleopSwerve(()->-Controls.controller.getRawAxis(1), ()->-Controls.controller.getRawAxis(0), ()->Controls.controller.getRawAxis(4), ()->false, ()->Swerve.get().AngleForSpeaker().getDegrees(), 0, true, true));
