...
public class Shooter extends SubsystemHandler {
    ...
    public void moveSerializerByRot(double rotations){

        PositionDutyCycle c=new PositionDutyCycle(0);
        m_Serializer.setControl(c.withPosition(m_Serializer.getPosition()+rotations));
    }
    ...
    public void initSendable(SendableBuilder builder) {  
        builder.addBooleanProperty("BeamBreak", this::getBeamBreak, null);
